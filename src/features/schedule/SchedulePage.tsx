          ...
          <div className="overflow-auto flex-1">
            <div style={{ minWidth: viewMode === 'month' ? '1200px' : '900px' }}>
              ...
              <div className="flex sticky top-0 z-40 bg-[var(--color-bg-card)] border-b border-[var(--color-border)] shadow-sm">
                <div className="w-72 flex-shrink-0 border-r border-[var(--color-border)] p-3 sticky left-0 z-50 bg-[var(--color-bg-card)] schedule-team-col">
                ...
                {teams?.map(team => {
                  ...
                  return (
                    <div key={team.id} className="flex border-b border-[var(--color-border)] group hover:bg-white/[0.02] transition-colors relative min-h-[100px]">
                      ...
                      <div className="w-72 flex-shrink-0 p-5 border-r border-[var(--color-border)] bg-[var(--color-bg-sidebar)] z-30 transition-all group-hover:bg-[var(--color-bg-card)] flex flex-col justify-center sticky left-0 shadow-[4px_0_15px_rgba(0,0,0,0.1)] schedule-team-col">
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="mt-1 workload-bar">
