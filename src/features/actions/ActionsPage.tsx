...
export function ActionsPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--color-bg-app)] overflow-hidden">
      ...
      {/* Header Premium Area */}
      <div className="flex-shrink-0 bg-[var(--color-bg-sidebar)] border-b border-[var(--color-border)] px-4 md:px-6 py-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-bold text-[var(--color-text-main)] flex items-center gap-2">
              Actions <span className="text-xs font-mono bg-[var(--color-bg-input)] px-2 py-0.5 rounded-full text-[var(--color-text-faded)]">{stats.total}</span>
            </h1>
            <p className="text-xs text-[var(--color-text-muted)] mt-0.5">Suivi des engagements et décisions</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
             ...
             <div className="flex items-center gap-2 flex-1 md:flex-none">
                ...
                <Button variant="primary" size="sm" onClick={() => setIsCreateOpen(true)} className="px-4">
                  <Plus className="w-4 h-4 sm:mr-2" /> <span className="hidden sm:inline">Nouvelle</span>
                </Button>
             </div>
          </div>
        </div>
